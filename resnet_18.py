...
class ResNet18_1D(ResNet1D):
    def __init__(self, num_classes=10, dropout_rate=0.5):
        super(ResNet18_1D, self).__init__(BasicBlock1D, [2, 2, 2, 2], num_classes=num_classes, dropout_rate=dropout_rate) 

class ResNet32_1D(ResNet1D):
    def __init__(self, num_classes=10, dropout_rate=0.5):
        super(ResNet32_1D, self).__init__(BasicBlock1D, [5, 5, 5, 5], num_classes=num_classes, dropout_rate=dropout_rate) 
